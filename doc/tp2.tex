...
\subsection{$k$ vetores aleatórios}

Como será apresentado na seção seguinte, cada uma das observações e consequentemente também cada um dos centróides é definido como um ponto em $[0, 1]^{M}$.
